...
export default function LoginPage() {
  ...
  if (exchanging) return (
    <div style={{ minHeight: '100vh', backgroundColor: DARK, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Arial, sans-serif' }}>
      <div style={{ textAlign: 'center' }}>
        <div style={{ width: '40px', height: '40px', border: `3px solid ${AMBER}`, borderTopColor: 'transparent', borderRadius: '50%', margin: '0 auto 16px' }} />
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: DARK, display: 'flex', flexDirection: 'column', fontFamily: 'Arial, sans-serif' }}>
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '130px' }}>
                  ...
                  <div style={{
                    ...
                    boxShadow: isActive ? `0 0 28px ${step.color}88` : 'none',
                    marginBottom: '14px',
                  }}>
                  ...
                  <div style={{
                    ...
                    color: isActive ? '#fff' : isFuture ? 'rgba(255,255,255,0.2)' : 'rgba(255,255,255,0.5)',
                    textAlign: 'center', lineHeight: 1.3, marginBottom: '6px',
                    transition: 'all 0.5s ease',
                    whiteSpace: 'pre-line',
                  }}>
                    {step.label}
                ...
                {i < STEPS.length - 1 && (
                  <div style={{
                    ...
                    width: '48px', marginBottom: '40px', flexShrink: 0,
                  }}>
                    <div style={{
                      ...
                      <div style={{
                        ...
                        backgroundColor: i < activeStep ? 'rgba(255,255,255,0.35)' : 'rgba(255,255,255,0.1)',
                      ...
                      <div style={{
                        ...
                        borderLeft: `10px solid ${i < activeStep ? 'rgba(255,255,255,0.35)' : 'rgba(255,255,255,0.1)'}`,
      ...
      {/* Bottom section — sign in card */}
      <div style={{ display: 'flex', justifyContent: 'center', padding: '0 64px 48px' }}>
        <div style={{
          backgroundColor: '#F5F5F2', borderRadius: '16px', padding: '36px 40px',
          width: '100%', maxWidth: '480px', boxShadow: '0 24px 80px rgba(0,0,0,0.4)',
        }}>
          {!sent ? (
            <>
              ...
              <div style={{ marginBottom: '14px' }}>
                ...
                <input
                  ...
                  style={{ width: '100%', padding: '11px 14px', fontSize: '14px', border: '1.5px solid #D8D5CC', borderRadius: '8px', outline: 'none', boxSizing: 'border-box', color: DARK, backgroundColor: '#fff' }}
                />
              </div>
              ...
              <button onClick={handleLogin} disabled={loading || !email} style={{
                width: '100%', padding: '12px', backgroundColor: loading || !email ? '#C8B89A' : AMBER,
